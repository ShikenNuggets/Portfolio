...
function ProjectEntry({ project, shortName, onClick, priority = false }: ProjectProps){
	...
	return(
		<div className='project-container' onClick={handleClick}>
			<Image src={imageName} width={1200} height={800} alt={project.title} priority={priority} />
